...
public class SwaggerConfig {
    ...
    private ApiInfo getInfo() {
        ...
        return new ApiInfo("Backend Blogging Application",
                "This is backend framework of Blogging application developed by Vinayak Singhal", "1.0", "Terms of Service",
                new Contact("Vinayak", "Not valid", "vinayaksinghal_mc21a13_15@dtu.ac.in"),
